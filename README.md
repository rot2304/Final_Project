...
משקולת זו היא מדד של אורינטציה ולא של חשיבות, ניתן להשתמש בו כהשוואה בין מסמכים על מרחב מנורמל מכיוון שאנחנו לא לוקחים בחשבון את החשיבות של כל מדד tf idf
